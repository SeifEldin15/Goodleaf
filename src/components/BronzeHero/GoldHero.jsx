...
const GoldHero = () => {
  return (
    <div className="relative flex items-center justify-center text-center text-white h-screen bg-[#1a1a2e] bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('/heros-assets/gold.png')"}}>
      <div className="absolute top-0 left-0 w-full h-full bg-black/20"></div>
      <div className="z-10 w-full max-w-[1200px] px-2.5">
        <h1 className="font-['Rajdhani'] font-bold text-[80px] leading-[70px] text-center uppercase mx-auto relative w-[594px] shadow-[0px_0px_6px_rgba(192,192,192,0.1)]" style={{color: '#FFA800'}}>PREMIUM VPS</h1>
