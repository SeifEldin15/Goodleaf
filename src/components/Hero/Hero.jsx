      ...
      <div className="container mx-auto flex items-center justify-between mt-12">
        ...
        <div className="max-w-xl">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 bg-[#0B1B2B] rounded-full py-2 px-3 max-w-[500px]">
              <div className="bg-[#0B7FE3]/10 rounded-full p-2">
                <svg className="w-6 h-6 text-[#0B7FE3]" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.64 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2zm-2 1H8v-6c0-2.48 1.51-4.5 4-4.5s4 2.02 4 4.5v6z"/>
                </svg>
              </div>
              <p className="text-white">5 Day money back guarantee on all hosting products*</p>
            </div>
