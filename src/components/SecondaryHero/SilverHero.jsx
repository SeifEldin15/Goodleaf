...
const SilverHero = () => {
  return (
    <div className="relative flex items-center justify-center text-center text-white min-h-[600px] md:min-h-[800px] lg:min-h-[900px] bg-[#1a1a2e] bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('/heros-assets/hero_bg.webp')"}}>
