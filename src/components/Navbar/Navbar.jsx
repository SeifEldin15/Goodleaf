...
// Add custom CSS for the navbar breakpoint
const navbarStyles = `
    ...
    <>
      ...
      >
        <Parallax translateY={[-5, 5]}>
          <motion.div 
            className="max-w-[95%] mx-auto flex items-center justify-between"
            initial="hidden"
            animate="visible"
          ...
          >
            ...
            {/* Desktop Navigation */}
            <motion.div 
              className="navbar-desktop-view items-center space-x-6"
              variants={containerVariants}
            >
            ...
            {/* CTA Buttons */}
            <motion.div 
              className="navbar-desktop-view items-center space-x-4"
              variants={containerVariants}
            >
            ...
            <motion.button
              variants={itemVariants}
              className="navbar-mobile-view text-gray-300 hover:text-white"
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div 
              ...
              className="navbar-mobile-view bg-black overflow-hidden"
            >
