...
const Footer = () => {
    return (
        <footer className="bg-gray-900 text-white py-8 ">
            <div className="container mx-auto flex flex-col md:flex-row justify-between max-w-7xl mx-auto">
                <div className="flex flex-col mb-4 items-center">
                    <img src="/logo.png" alt="GoodLeaf" className="max-w-56 mb-4" />
                ...
                <div className="flex flex-col mb-4">
                    <h3 className="font-semibold text-[#1D90F0]">Help Center</h3>
                ...
                <div className="flex flex-col mb-4">
                    <h3 className="font-semibold text-[#1D90F0]">Partners</h3>
                ...
                <div className="flex flex-col mb-4">
                    <h3 className="font-semibold text-[#1D90F0]">Our Products</h3>
                ...
                <div className="flex flex-col mb-4">
                    <h3 className="font-semibold text-[#1D90F0]">Account</h3>
