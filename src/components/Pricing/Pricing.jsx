...
const PricingCard = ({ title, price, features, location, labels }) => (
  <div className="p-6 bg-[#111827] rounded-xl hover:bg-[#1a2438] transition-colors duration-300 relative overflow-hidden">
    {/* Background image with overlay */}
    <div className="absolute inset-0 z-0">
      <div className="absolute inset-0 bg-gradient-to-b from-black/70 to-[#111827] z-10" />
      <img 
        src={`/`} 
        alt="" 
        className="w-full h-[200px] object-cover"
      />
      <div className="absolute inset-0 bg-[#111827]/80 backdrop-blur-sm z-20" />
    </div>

    {/* Wrap all content in a relative container to sit above the background */}
