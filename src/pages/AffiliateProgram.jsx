    ...
    <div className="min-h-screen bg-[#0F1429] text-white">
      ...
      <div className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-3xl md:text-4xl font-bold mb-12 text-center text-[#0B7FE3]"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="relative z-30">
                <h3 className="text-xl font-bold mb-6 text-white">Tier 1 (10 referrals)</h3>
            ...
            >
              <div className="relative z-30">
                <h3 className="text-xl font-bold mb-6 text-white">Tier 2 (25 referrals)</h3>
                <ul className="space-y-4 text-white">
                  <li className="flex items-start">
                    <span className="text-white mr-2">•</span>
            ...
            >
              <div className="relative z-30">
                <h3 className="text-xl font-bold mb-6 text-white">Tier 3 (50 referrals)</h3>
                <ul className="space-y-4 text-white">
                  <li className="flex items-start">
                    <span className="text-white mr-2">•</span>
      ...
      <div className="py-16 px-4 bg-[#0A0E1F]">
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-r from-[#040BFF] to-[#1E75FF] p-10 rounded-lg">
